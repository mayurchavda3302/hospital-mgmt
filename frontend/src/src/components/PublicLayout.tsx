    ...
    <div className="min-h-screen flex flex-col font-body bg-slate-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <Link href="/" className="flex items-center gap-2 cursor-pointer">
              ...
              <div>
                <h1 className="text-2xl font-display font-bold text-slate-900 leading-none">SV Hospitals</h1>
                <span className="text-xs text-muted-foreground font-medium tracking-wider">MULTISPECIALTY HOSPITAL</span>
              </div>
            </Link>
      ...
      <footer className="bg-slate-900 text-slate-300 py-12 border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center gap-2 mb-4 text-white">
              ...
              <span className="text-xl font-bold font-display">SV Hospitals</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 mt-12 pt-8 border-t border-slate-800 text-center text-xs opacity-60">
          © 2024 SV Hospitals. All rights reserved.
        </div>
      </footer>
    </div>
  );
