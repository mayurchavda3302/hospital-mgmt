...
export function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-secondary/50 flex">
      ...
      {/* Sidebar */}
      <aside className={cn(
        "fixed lg:static inset-y-0 left-0 z-50 w-64 bg-white border-r shadow-lg transform transition-transform duration-200 lg:transform-none flex flex-col",
        ...
        <div className="p-4 border-t bg-slate-50 mt-auto flex-shrink-0">
          ...
          <Button
            variant="ghost"
            className="w-full justify-start gap-2 text-destructive hover:text-destructive hover:bg-destructive/10 pl-2"
            onClick={() => logout()}
          >
